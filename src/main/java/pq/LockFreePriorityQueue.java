...
//     private class Node {
//         int key;
//         AtomicMarkableReference<T> value;
//         int level;
//         int validLevel;
...
//             this.key = key;
//             this.value = new AtomicMarkableReference<T>(value, false);
//             this.level = level;
//             this.validLevel = 0;
...
//             T val2 = node2.get().value.get(markHolder);
...
//             }
//             while (true) {
//                 AtomicMarkableReference<T> value = node1.get().value;
//                 if (!value.isMarked()) {
//                     if (node1.get().value.compareAndSet(node1.get().value.get(null), value.get(null), false, true)) {
//                         node1.get().prev = prev;
...
//     @Override
//     public T removeMin() {
//         return this.deleteMin().get().value.get(null);
//     }
